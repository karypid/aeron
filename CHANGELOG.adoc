...
* **[Driver]** Creating/destroying exclusive publications with explicitly specified `session-id` now works without
errors.
...
* **[Driver/Java]** Allow immediate re-creation of an exclusive publication with fixed `session-id`.
* **[Java]** Upgrade to `Gradle` 9.5.1.
* **[Java]** Upgrade to `JUnit` 6.1.0.
* **[Java]** Upgrade to `ByteBuddy` 1.18.9.
* **[Java]** Upgrade to `Shadow` 9.4.2.
