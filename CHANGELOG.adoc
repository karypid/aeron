...
applied correctly when set. Furthermore, native resource agent thread ends sharing the same core as the `conductor`
thread when that is configured.
+
Affects <<1.52.0 (2026-07-03)>> and <<1.51.1 (2026-06-30)>>.
