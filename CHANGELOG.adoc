...
* **[Driver]** Add support for `control-mode=response` and `session-id` specified together in the replay channel
to `PersistentSubscription`. (https://github.com/aeron-io/aeron/issues/2137[#2137])
