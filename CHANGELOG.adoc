...
* **[C]** Accept `AERON_HDR_TYPE_ATS_SM` along `AERON_HDR_TYPE_SM` frames in order to support DPDK/ATS setup where raw frames are checked before forwarding them to the `sender` thread.
