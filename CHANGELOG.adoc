...
* **[Client/C]** Fix `aeron_subscription_resolved_endpoint` signature, i.e. remove const from the out parameter `address`. (https://github.com/aeron-io/aeron/issues/2130[#2130])
