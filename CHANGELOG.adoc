...
* **breaking**  [ConsensusModuleExtension/Java] Removed unused method `supportedSchemaId()` that gave the impression as if there could only be a single schema supported by an extension. This is a breaking change in an internal API.
