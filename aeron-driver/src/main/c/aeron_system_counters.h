...
typedef enum aeron_system_counter_enum_stct
{
    ...
    AERON_SYSTEM_COUNTER_STATUS_MESSAGES_REJECTED = AERON_SYSTEM_COUNTER_ID_STATUS_MESSAGES_REJECTED,
    AERON_SYSTEM_COUNTER_NATIVE_RESOURCE_AGENT_PROXY_FAILS = AERON_SYSTEM_COUNTER_ID_NATIVE_RESOURCE_AGENT_PROXY_FAILS,
