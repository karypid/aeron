...
#define AERON_COUNTER_SEQUENCER_APPLICATION_GREATEST_COMMITTED_MESSAGE_ID_COUNTER_TYPE_ID (526)

#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_SESSION_COUNT_TYPE_ID (531)

#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_INDEXED_TERM_COUNT_TYPE_ID (535)

#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_TOTAL_TERM_COUNT_TYPE_ID (536)

#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_REPLAY_JOB_TYPE_ID (537)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_STORE_OPERATIONS_COUNTER_TYPE_ID (538)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_LOAD_OPERATIONS_COUNTER_TYPE_ID (539)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_REPLICATING_COUNT_TYPE_ID (540)

#define AERON_COUNTER_SEQUENCER_APPLICATION_LAST_READ_TIMESTAMP_COUNTER_TYPE_ID (541)

#define AERON_COUNTER_SEQUENCER_REPLAY_CLIENT_LOG_REPLAY_SEQUENCE_INDEX_TYPE_ID (542)

#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_STATE_TYPE_ID (543)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_STATE_TYPE_ID (544)
